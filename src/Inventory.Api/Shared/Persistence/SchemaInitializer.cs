...
/// <summary>Applies db/schema.sql then db/seed.sql before the server starts listening (ADR-005).</summary>
public sealed class SchemaInitializer(NpgsqlDataSource dataSource) : IHostedLifecycleService
{
